...
library(tidyverse)
here()
chapter_5_schooling_earn <- read_csv(here('just', 'Files for Data Exercises', 'SchoolingEarnings.csv'))
...
ggplot(data = chapter_5_schooling_earn)+
  ...
  theme_classic()
ggsave(here('just','Images', 'Figure 1.jpeg'))
...
ggplot(predicted_data) +
  ...
  theme_classic()
ggsave(here('just', 'Images', 'Figure 2.jpeg'))
...
ggplot(data=chapter_5_schooling_earn, aes(schooling,earnings)) +
  ...
  theme_classic()
ggsave(here('just', 'Images', 'Figure 3.jpeg'))
